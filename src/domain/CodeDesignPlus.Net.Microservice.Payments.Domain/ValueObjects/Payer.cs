...
public partial class Payer
{
    ...
    [JsonConstructor]
    private Payer(string emailAddress, string fullName, Address billingAddress, string dniNumber, string contactPhone)
    {
    ...
    public static Payer Create(string emailAddress, string fullName, Address billingAddress, string dniNumber, string contactPhone)
    {
        return new Payer(emailAddress, fullName, billingAddress, dniNumber, contactPhone);
    }
}
